@echo off
echo Starting SQLite Forensic Artifact Analyzer with persistence fixes...
...
echo.
echo IMPORTANT: Your database files are now persistently stored and won't disappear when refreshing!
echo The uploaded files are stored at: %TEMP%\sqlite_analyzer_uploads
echo. 